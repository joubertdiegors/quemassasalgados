...
urlpatterns = [
    path('list/', views.SalesOrderListView.as_view(), name='sales_order_list'),
    path('<int:pk>/', views.SalesOrderDetailView.as_view(), name='sales_order_detail'),
    path('create/', views.SalesOrderCreateView.as_view(), name='sales_order_create'),
    path('edit/<int:pk>/', views.sales_order_update_view, name='sales_order_update'),
    path('delete/<int:pk>/', views.SalesOrderDeleteView.as_view(), name='sales_order_delete'),
